  ...
  <div class="grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
      ...
      <div class="mt-5 intro-y box">
        ...
        >
          <h2 class="mr-auto text-base font-medium">Informacion personal</h2>
        </div>
        <div class="p-5">
          <div class="grid grid-cols-12 gap-x-5">
            <div class="col-span-12 xl:col-span-6">
              <div>
                <FormLabel htmlFor="update-profile-form-6">Correo</FormLabel>
                <FormInput
              ...
              <div class="mt-3">
                <FormLabel htmlFor="update-profile-form-7">Nombres</FormLabel>
                <FormInput
          ...
          <div class="flex justify-end mt-4">
            <Button variant="primary" type="button" class="w-20 mr-auto">
              Guardar
            </Button>
            <!-- <a href="" class="flex items-center text-danger">
              <Lucide icon="Trash2" class="w-4 h-4 mr-1" /> Delete Account
            </a> -->
          </div>
        </div>
      </div>
